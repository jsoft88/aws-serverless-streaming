...
export SERVICES="lambda,kinesis,firehose,s3,cloudformation,iam,ec2,s3,ssm,sts"
...
# RDS Master Username
export db_master_username="python" # password will be create on-the-fly and associtated w/ this user
export db_password_secret_ssm_key="password-secret-${env}"
export delivery_stream_name="kinesis-db-changes-stream-${env}"
export lambda_kinesis_stream_processor_bucket="lambdas.stream.test"
